...
get_schemas_teradata <- function(con) {
  tryCatch({
    schemas <-
      DBI::dbGetQuery(
        con,
...
get_tables_teradata <- function(con, schema) {
  result <- tryCatch({
    DBI::dbGetQuery(
      con,
      glue::glue(
...
get_n_rows_teradata <- function(con, schema, table, query = "") {
...
get_preview_teradata <- function(con, schema, table) {
  dbGetQuery(
    con,
    glue(
      "
...
delete_table_teradata <- function(con, schema, table){
